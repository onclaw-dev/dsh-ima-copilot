...
function apply(ctx, config) {
	...
	ctx.effect(() => ctx.tools.register(createImaTool(ctx, resolved, client)), "ima-copilot: native tool registration");
}
//#endregion
export { Config, IMA_CREDENTIAL_REFS, IMA_KNOWLEDGE_BASE_IDS_REF, IMA_RUNTIME_REFS, IMA_TOOL_NAME, IMA_X_IMA_BKN_REF, IMA_X_IMA_COOKIE_REF, ImaClient, ImaError, apply, createImaTool, inject, name, parseKnowledgeBaseIds, resolveConfig, resolveRuntimeState, selectKnowledgeBase };
